    ...
    const editor = useEditor({
        extensions: [
            ...
            Placeholder.configure({
                ...
                emptyEditorClass: "first:before:text-gray-400 first:before:float-left first:before:content-[attr(data-placeholder)] first:before:pointer-events-none"
            }),
        ],
        editorProps: {
           attributes: {
        ...
        <div className="flex flex-col gap-2">
            {editor && (
                <div className="border border-input rounded-md">
                    ...
                    <Toggle pressed={editor.isActive("unorderedList")} onPressedChange={() => {editor.chain().focus().toggleBulletList().run()}}>
                        <List size={20}/>
                    </Toggle>
